...
# LAST UPDATED
2026-07-02 — SESSION-0018: Fix — Medir separa Distancia/Área en sub-modos explícitos (antes: Área capturaba todo click sobre un elemento, haciendo imposible medir distancia entre puntos dentro de elementos)
